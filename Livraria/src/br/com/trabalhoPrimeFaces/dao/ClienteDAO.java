...
public final class ClienteDAO extends AbstractDAO{
	...
	/**
	 * Método que verifica se o cliente já comprou algum livro
	 * @return Retorna verdadeiro caso o cliente já tenha comprado algum livro 
	...
	public boolean deny( Integer id ) {
	    ...
	    for (int i = 0; i < listaVenda.size(); i++) {  
	        if (id.equals(listaVenda.get(i).getCliente())) {
				error = "message.show()";
				return true;
	    	}
	    }
